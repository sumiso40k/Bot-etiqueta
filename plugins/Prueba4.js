      ...
      imageMessages.push({
        ...
        'nativeFlowMessage': proto.Message.InteractiveMessage.NativeFlowMessage.fromObject({
          'buttons': [{
            ...
            'buttonParamsJson': "{\"display_text\":\"url 🔍\",\"url\":\"https://www.pinterest.com/search/pins/?rs=typed&q=" + encodeURIComponent(text) + "\",\"merchant_url\":\"https://www.pinterest.com/search/pins/?rs=typed&q=" + encodeURIComponent(text) + "\"}" // Parámetros del botón
          }]
        })
      });
    }
