...
const smsRowner = () => { return `𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙔𝙊 𝙤 𝙢𝙞 𝙋𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤 𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙪𝙨𝙖𝙧` }//NUMERO DE BOT
const smsOwner = () => { return `𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙔𝙊 𝙤 𝙢𝙞 𝙋𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤 𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙪𝙨𝙖𝙧` }//OWNER
const smsMods = () => { return `𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙡𝙤𝙨 𝙥𝙪𝙚𝙙𝙚𝙣 𝙪𝙨𝙖𝙧 𝙇𝙤𝙨 𝙢𝙤𝙙𝙚𝙧𝙖𝙙𝙤𝙧𝙚𝙨 𝙮 𝙢𝙞 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤 (𝙤𝙬𝙣𝙚𝙧) 𝙙𝙚𝙡 𝘽𝙤𝙩!!` }//MODERADORES
const smsPremium = () => { return `𝙏𝙪 𝙣𝙤 𝙚𝙧𝙚𝙨 𝙪𝙨𝙪𝙖𝙧𝙞𝙤 𝙥𝙧𝙚𝙢𝙞𝙪𝙢 🤓, 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙚𝙨 𝙥𝙖𝙧𝙖 𝙪𝙨𝙪𝙖𝙧𝙞𝙤 𝙥𝙧𝙚𝙢𝙞𝙪𝙢 𝙮 𝙚𝙡 𝙥𝙧𝙤𝙥𝙞𝙚𝙩𝙖𝙧𝙞𝙤/𝙖 (𝙤𝙬𝙣𝙚𝙧) 𝙙𝙚𝙡 𝘽𝙤𝙩!!` }//USUARIOS PREMIUM
const smsGroup = () => { return `𝙋𝙚𝙣𝙙𝙚𝙟𝙤 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙡𝙤 𝙥𝙪𝙚𝙙𝙚𝙣 𝙪𝙨𝙖𝙧 𝙚𝙣 𝙜𝙧𝙪𝙥𝙤𝙨` }//PARA GRUPOS
const smsPrivate = () => { return `𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙨𝙚 𝙥𝙪𝙚𝙙𝙚 𝙪𝙩𝙞𝙡𝙞𝙯𝙖𝙧 𝙖𝙡 𝙥𝙧𝙞𝙫𝙖𝙙𝙤 𝙙𝙚𝙡 𝘽𝙤𝙩` }//AL PRIVADO
const smsAdmin = () => { return `𝙏𝙪 𝙣𝙤 𝙚𝙧𝙚𝙨 𝙖𝙙𝙢𝙞𝙣 🤣, 𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙡𝙤 𝙥𝙪𝙚𝙙𝙚𝙣 𝙪𝙨𝙖𝙧 𝙡𝙤𝙨 𝙖𝙙𝙢𝙞𝙣𝙨 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤!!` }//ADMINS
const smsBotAdmin = () => { return `𝙃𝙚𝙮 𝙥𝙧𝙞𝙢𝙚𝙧𝙤 𝙚𝙡 𝘽𝙤𝙩 𝙤𝙨𝙚𝙖 (𝙔𝙤), 𝙉𝙚𝙘𝙚𝙨𝙞𝙩𝙤 𝙨𝙚𝙧 𝙖𝙙𝙢𝙞𝙣 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤` }//BOT CON ADMIN
const smsUnreg = () => { return `¡¡🙌 𝙃𝙀𝙔 𝘼𝙇𝙏𝙊, 𝙉𝙊 𝙀𝙎𝙏𝘼 𝙍𝙀𝙂𝙄𝙎𝙏𝙍𝘼𝘿𝙊!! 🙌\n𝙋𝙖𝙧𝙖 𝙥𝙤𝙙𝙚𝙧 𝙪𝙨𝙖𝙧 𝙚𝙡 𝘽𝙤𝙩 𝙣𝙚𝙘𝙚𝙨𝙞𝙩𝙖 𝙧𝙚𝙜𝙞𝙨𝙩𝙧𝙖𝙧𝙩𝙚,  𝙪𝙨𝙖 𝙚𝙡 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 /𝙫𝙚𝙧𝙞𝙛𝙞𝙘𝙖𝙧` }//VERIFICAR
...
const smsVersion = () => { return `𝙑𝙚𝙧𝙨𝙞𝙤𝙣 𝙙𝙚𝙡 𝙏𝙝𝙚-𝘼𝙞𝙧𝙞𝘽𝙤𝙩`}
...
const smsBye = () => { return '*Largate de aqui naco @user**'}
